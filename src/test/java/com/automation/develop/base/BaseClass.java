...
import com.automation.develop.utilities.SyncPipe;
...
//            logger.info("Property File Already in use");
    ...
    ------------------------------------------------------- */
    public static void initializeRemoteWebDriver(String browser, boolean headless) throws Exception {
//        if (driver == null) {
    ...
    @Override
    public void initializeBrowserUsingDriverManager(@NotNull String browser, boolean headless) {
        if (browser.equalsIgnoreCase("chrome")) {
            ChromeOptions chromeOptions = new ChromeOptions();
...
//
//            URL url = new URL("http://10.5.53.225:4444");
//            WebDriverManager.chromedriver().cachePath("C:\\ManishMain\\Automation\\weathershopper\\weathershopper\\src\\test\\resources\\Executables").setup();
